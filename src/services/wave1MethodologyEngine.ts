...
import { BmWa03001Engine, type BmWa03001Inputs, type BmWa03001Result } from "./bmWa03001Engine.ts";
...
export type Wave1EngineResult =
  ...
  | { methodologyId: "BM-WA03.001"; result: BmWa03001Result }
  | { methodologyId: "BM-WA03.003"; result: BmWa03003Result };

export function runWave1Methodology(
  context: MethodologyProjectContext,
  input: BmAg04001Inputs | BmIn02002Inputs | BmWa03001Inputs | BmWa03003Inputs,
  ...
  switch (methodologyId) {
    ...
    case "BM-WA03.001":
      return { methodologyId, result: BmWa03001Engine.calculate(input as BmWa03001Inputs) };
    case "BM-WA03.003":
