...
class EnterpriseMrvStore {
  ...
  private seedInitialActivityData() {
    // Generate some initial MRV events
    const firstEvtId = 'MRV_EVT_001';
    const secondEvtId = 'MRV_EVT_002';

    this.mrvEvents = [
      {
        eventId: firstEvtId,
        projectId: 'PRJ_MUNICIPAL_EAST',
        operatingMode: OperatingMode.URBAN,
        eventType: 'COLLECTION',
        sourceType: 'Ward 25 Domestic Segregation',
        sourceId: 'WARD_25_COLL_01',
        actorId: 'ACTOR_MUNI_COLL',
        organizationId: 'ORG_EAST_MUNI',
        facilityId: 'FAC_EAST_MRF',
        assetId: 'TRUCK_UP16_7392',
        batchId: 'BATCH_ACM0022_A1',
        timestamp: '2026-07-10T08:30:00Z',
        recordedAt: '2026-07-10T09:15:00Z',
        latitude: 26.8467,
        longitude: 80.9462,
        measurement: 2450, // 2.45 tonnes
        unit: 'kg',
        evidenceRefs: ['EVID_PHOTO_001', 'EVID_WEIGH_001'],
        dataQuality: 95,
        verificationStatus: VerificationStatus.VERIFIED,
        integrityHash: 'sha256_27a92b7c4d1e0f...',
        schemaVersion: '1.0'
      },
      {
        eventId: secondEvtId,
        projectId: 'PRJ_RURAL_FPO_01',
        operatingMode: OperatingMode.RURAL,
        eventType: 'BIOMASS_AGGREGATION',
        sourceType: 'Rice straw field baling',
        sourceId: 'FPO_PUNJAB_CELL_04',
        actorId: 'ACTOR_FPO_LEAD',
        organizationId: 'ORG_PUNJAB_COOP',
        facilityId: 'FAC_BIOMASS_STORAGE_B',
        assetId: 'BALER_JOHN_DEERE_12',
        batchId: 'BATCH_BIOMASS_R_99',
        timestamp: '2026-07-10T11:45:00Z',
        recordedAt: '2026-07-10T12:00:00Z',
        latitude: 30.9010,
        longitude: 75.8573,
        measurement: 4800, // 4.8 tonnes
        unit: 'kg',
        evidenceRefs: ['EVID_PHOTO_002'],
        dataQuality: 82,
        verificationStatus: VerificationStatus.PENDING,
        integrityHash: 'sha256_3b8f1e0d2c5a7b...',
        schemaVersion: '1.0'
      }
    ];
    ...
    this.evidenceRecords = [
      {
        evidenceId: 'EVID_PHOTO_001',
        projectId: 'PRJ_MUNICIPAL_EAST',
        eventId: firstEvtId,
        evidenceType: EvidenceType.PHOTO,
        source: 'Android Field App Camera',
        fileReference: '/uploads/wards/seg_check_25.jpg',
        capturedAt: '2026-07-10T08:31:00Z',
        uploadedAt: '2026-07-10T09:10:00Z',
        actor: 'Municipal Supervisor Manoj',
        deviceId: 'SM_A345G_998',
        latitude: 26.8468,
        longitude: 80.9463,
        metadata: { segregationLevel: 'Grade A', organicPercent: 92 },
        checksum: 'md5_3b8a1c9...',
        integrityHash: 'sha256_photo_9921b...',
        reviewStatus: 'Approved',
        verificationStatus: EvidenceStatus.VERIFIED,
        confidentialityClass: 'PUBLIC',
        retentionPolicy: '5_YEARS',
        schemaVersion: '1.0'
      },
      {
        evidenceId: 'EVID_WEIGH_001',
        projectId: 'PRJ_MUNICIPAL_EAST',
        eventId: firstEvtId,
        evidenceType: EvidenceType.WEIGHBRIDGE_SLIP,
        source: 'MRF Weighbridge Integration',
        fileReference: '/uploads/receipts/wb_3847291.pdf',
        capturedAt: '2026-07-10T09:14:00Z',
        uploadedAt: '2026-07-10T09:15:00Z',
        actor: 'MRF Scalemaster Amit',
        deviceId: 'WB_EAST_01',
        metadata: { grossWeightKg: 4820, tareWeightKg: 2370, netWeightKg: 2450 },
        checksum: 'md5_ff02a9...',
        integrityHash: 'sha256_weigh_3812a...',
      ...
      {
        evidenceId: 'EVID_PHOTO_002',
        projectId: 'PRJ_RURAL_FPO_01',
        eventId: secondEvtId,
        evidenceType: EvidenceType.PHOTO,
        source: 'FPO Field Device',
        fileReference: '/uploads/stubble/bales_4.jpg',
        capturedAt: '2026-07-10T11:47:00Z',
        uploadedAt: '2026-07-10T11:58:00Z',
        actor: 'FPO Collector Gurpreet',
        latitude: 30.9011,
        longitude: 75.8575,
        metadata: { cropResidueType: 'Rice Straw', baleCount: 24 },
        checksum: 'md5_bb77123...',
        integrityHash: 'sha256_photo_stubble...',
    ...
    this.evidencePackages = [
      {
        packageId: 'PKG_EAST_MUNI_BATCH1',
        projectId: 'PRJ_MUNICIPAL_EAST',
        name: 'Municipal Organic Segregation Ward 25',
        description: 'Complete evidence checklist for Municipal Composting ACM0022 compliance',
        evidenceIds: ['EVID_PHOTO_001', 'EVID_WEIGH_001'],
        completenessScore: 100,
        status: EvidenceStatus.VERIFIED,
        createdAt: '2026-07-10T09:20:00Z',
        updatedAt: '2026-07-10T09:22:00Z'
      }
    ];
    ...
    this.massBalances = [
      {
        recordId: 'MB_001',
        facilityId: 'FAC_EAST_MRF',
        materialType: 'Organic Municipal Waste',
        monitoringPeriodId: 'MP_2026_Q1',
        openingStock: 12.5, // tonnes
        inputs: 145.8,
        outputs: 110.2, // compost processed
        transformations: 24.1, // mass reduction (moisture loss)
        losses: 12.4, // evaporation and process loss
        rejections: 1.8, // inorganic contamination rejected
        closingStock: 9.8,
        expectedBalance: 9.8,
        observedBalance: 9.8,
        variance: 0,
    ...
    this.alerts = [
      {
        alertId: 'AL_001',
        alertType: 'GPS_TRACE_INCONSISTENCY',
        severity: 'MEDIUM',
        affectedRecords: [firstEvtId],
        reason: 'The upload GPS trace coordinate (26.8467, 80.9462) differs from the vehicle GPS trace logging at the timestamp of tipping by 85 meters.',
        supportingSignals: ['Vehicle GPS unit: 26.8461, 80.9455', 'Field App Capture: 26.8467, 80.9462'],
        modelReference: 'AI_GPS_MATCH_v1',
        modelVersion: '1.0',
