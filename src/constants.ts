...
export const WASTE_TYPES: WasteType[] = [
  // Agricultural
  { type: "Crop Residue (Stubble/Straw)", category: "Agricultural", value: 8, carbon: 1.5 },
  { type: "Rice Husk & Bran", category: "Agricultural", value: 10, carbon: 1.5 },
  { type: "Wheat Bran", category: "Agricultural", value: 9, carbon: 1.5 },
  { type: "Sugarcane Bagasse", category: "Agricultural", value: 12, carbon: 1.5 },
  { type: "Pressmud", category: "Agricultural", value: 7, carbon: 1.5 },
  { type: "Cotton Stalks", category: "Agricultural", value: 6, carbon: 1.5 },
  { type: "Maize Cobs & Stalks", category: "Agricultural", value: 7, carbon: 1.5 },
  { type: "Coconut Shells & Coir", category: "Agricultural", value: 15, carbon: 1.5 },
  { type: "Groundnut Shells", category: "Agricultural", value: 11, carbon: 1.5 },
  { type: "Fruit & Vegetable Pomace", category: "Agricultural", value: 9, carbon: 1.5 },
  { type: "Spent Grain (Brewery)", category: "Agricultural", value: 12, carbon: 1.5 },
  { type: "Coffee Grounds/Husks", category: "Agricultural", value: 14, carbon: 1.5 },
  { type: "Tea Waste", category: "Agricultural", value: 10, carbon: 1.5 },
  
  // Municipal
  { type: "Municipal Organic Waste", category: "Municipal", value: 5, carbon: 0.9 },
  { type: "Food & Kitchen Waste", category: "Municipal", value: 6, carbon: 0.9 },
  { type: "Garden & Leaf Litter", category: "Municipal", value: 4, carbon: 0.9 },
  { type: "Paper & Cardboard Waste", category: "Municipal", value: 11, carbon: 0.9 },
  ...
  // Plastics
  { type: "PET Bottles (Clear)", category: "Plastics", value: 35, carbon: 2.7 },
  { type: "HDPE Containers", category: "Plastics", value: 30, carbon: 2.7 },
  { type: "LDPE Film/Wrap", category: "Plastics", value: 25, carbon: 2.7 },
  { type: "PP Rigid Plastic", category: "Plastics", value: 28, carbon: 2.7 },
  { type: "PVC Scraps", category: "Plastics", value: 15, carbon: 2.7 },
  { type: "Multi-Layered Plastic (MLP)", category: "Plastics", value: 12, carbon: 2.7 },
