...
function getLGDInfo(state: string, district: string, localArea: string, context = 'Urban', subdistrict?: string) {
  ...
  const users: any[] = [
    ...
    },
    {
      ...
      name: "Jabalpur Municipal Corporation Admin",
      organization_name: "JMC Urban Local Body",
      district: "Jabalpur",
    ...
    },
    {
      ...
      password: demoHashedPassword,
      role: "fpo",
      name: "Sukhdev Singh (Sihora FPO)",
      organization_name: "Sihora Farmers Producer Org",
      district: "Jabalpur",
      state: "Madhya Pradesh",
    ...
    },
    {
      ...
      password: demoHashedPassword,
      role: "aggregator",
      name: "Ramesh Aggregator (Bada Kabadiwala)",
      organization_name: "Central Scrap Depot Yard",
      district: "Jabalpur",
      state: "Madhya Pradesh",
    ...
    },
    {
      ...
      password: demoHashedPassword,
      role: "processor",
      name: "Mahakaushal PolyRecycle MRF",
      organization_name: "PolyRecycle Processing Plant",
      district: "Jabalpur",
      state: "Madhya Pradesh",
    ...
    },
    {
      ...
      password: demoHashedPassword,
      role: "ACVA_USER",
      name: "Dr. Ananya Sharma (ACVA Lead Auditor)",
      organization_name: "Bureau of Energy Efficiency ACVA-001",
      district: "Delhi",
      state: "Delhi",
      wallet_balance: 0,
    },
    {
      ...
      password: demoHashedPassword,
      role: "citizen",
      name: "Aakash Verma (Resident Citizen)",
      organization_name: "Ward 14 Resident Welfare Association",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      wallet_balance: 3450,
    },
    {
      id: "farmer_1",
      phone: "9827011007",
      loginId: "farmer_ramesh",
      username: "farmer_ramesh",
      password: demoHashedPassword,
      role: "farmer",
      name: "Rameshwar Patel (Biomass Farmer)",
      organization_name: "Kisan Samridhi Producer Group",
      district: "Jabalpur",
      subdistrict: "Sihora",
      local_area: "Khajuri Village",
      state: "Madhya Pradesh",
    ...
    },
    {
      id: "safai_1",
      phone: "9827011008",
      loginId: "safai_sunita",
      username: "safai_sunita",
      password: demoHashedPassword,
      role: "safai_mitra",
      name: "Sunita Bai (Senior Safai Mitra)",
      organization_name: "JMC Swachhata Shramik Union",
      district: "Jabalpur",
      subdistrict: "Jabalpur Urban",
      local_area: "Ward 14 Civil Lines",
      state: "Madhya Pradesh",
      wallet_balance: 4800,
    },
    {
      id: "generator_1",
      phone: "9827011009",
      loginId: "hotel_radisson",
      username: "hotel_radisson",
      password: demoHashedPassword,
      role: "commercial_generator",
      name: "Hotel Radisson Blu Operations",
      organization_name: "Radisson Hotel Group MP",
      district: "Jabalpur",
      subdistrict: "Jabalpur Urban",
      local_area: "Commercial Ward 3",
      state: "Madhya Pradesh",
      wallet_balance: 0,
    },
    {
      ...
      password: demoHashedPassword,
      role: "PROJECT_OWNER",
      name: "Vikramaditya Rao (Carbon Project Developer)",
      organization_name: "Bharat BioCarbon Solutions Pvt Ltd",
      district: "Jabalpur",
      subdistrict: "Patan",
      local_area: "Biogas Cluster Zone 1",
      state: "Madhya Pradesh",
    ...
    },
    {
      id: "cpcb_1",
      phone: "9827011011",
      loginId: "cpcb_officer",
      username: "cpcb_officer",
      password: demoHashedPassword,
      role: "regulator",
      name: "Dr. K. S. Murthy (CPCB Regional Director)",
      organization_name: "Central Pollution Control Board (CPCB)",
      district: "Bhopal",
      subdistrict: "Paryavaran Parisar",
      local_area: "Bhopal HQ",
      state: "Madhya Pradesh",
      wallet_balance: 0,
    },
    {
      ...
      phone: "9827011012",
      loginId: "brand_dabur",
      username: "brand_dabur",
      password: demoHashedPassword,
      role: "epr_partner",
      name: "Dabur India Packaging EPR Cell",
      organization_name: "Dabur India Ltd EPR Directorate",
      district: "New Delhi",
      subdistrict: "Barakhamba",
      local_area: "Corporate HQ",
      state: "Delhi",
