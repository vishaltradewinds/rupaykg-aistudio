...
function getLGDInfo(state: string, district: string, localArea: string, context = 'Urban', subdistrict?: string) {
  ...
  const users: any[] = [
    ...
    },
    {
      ...
      loginId: "ulb_admin",
      username: "ulb_admin",
      email: "ulb.jabalpur@rupaykg.org",
      password: defaultHashedPassword,
      role: "municipal_admin",
      name: "Er. Rajesh Verma (Executive Officer)",
      organization_name: "Jabalpur Municipal Corporation (JMC)",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Jabalpur Urban",
      local_area: "Zone 4 / Ward 14 MRF",
      wallet_balance: 0,
    },
    {
      id: "state_admin_1",
      phone: "9827011002",
      loginId: "state_officer",
      username: "state_officer",
      email: "mp.udhd@rupaykg.org",
      password: defaultHashedPassword,
      role: "state_admin",
      name: "Dr. S. K. Mukherjee (Nodal Officer SBM)",
      organization_name: "Madhya Pradesh Urban Development & Housing Dept",
      district: "Bhopal",
      state: "Madhya Pradesh",
      wallet_balance: 0,
    },
    {
      id: "panchayat_admin_1",
      phone: "9827011003",
      loginId: "panchayat_admin",
      username: "panchayat_admin",
      email: "gp.khajuri@rupaykg.org",
      password: defaultHashedPassword,
      role: "panchayat_admin",
      name: "Sarpanch Devendra Patel",
      organization_name: "Khajuri Gram Panchayat & Biomass Cluster",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Patan",
      village: "Khajuri Village Resource Centre",
      local_area: "Khajuri",
      wallet_balance: 0,
    },
    {
      ...
      loginId: "fpo_leader",
      username: "fpo_leader",
      email: "narmada.fpo@rupaykg.org",
      password: defaultHashedPassword,
      role: "fpo",
      name: "Kisan Morcha Agro FPO (Director Rameshwar)",
      organization_name: "Narmada Valley Biochar & Crop Residue FPO",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Shahpura",
      village: "Bhedaghat Rural Sector",
      wallet_balance: 1450,
    },
    {
      id: "safai_mitra_1",
      phone: "9827011005",
      loginId: "safai_mitra",
      username: "safai_mitra",
      email: "safai.ramesh@rupaykg.org",
      password: defaultHashedPassword,
      role: "citizen",
      name: "Ramesh Safai Mitra (Door-to-Door Lead)",
      organization_name: "JMC Ward 14 Sanitation Union",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Jabalpur Urban",
      local_area: "Ward 14 Wright Town",
      wallet_balance: 385,
    },
    {
      id: "aggregator_1",
      phone: "9827011006",
      loginId: "aggregator_depot",
      username: "aggregator_depot",
      email: "depot.jabalpur@rupaykg.org",
      password: defaultHashedPassword,
      role: "aggregator",
      name: "M/s Central India Resource Aggregators",
      organization_name: "Central Scrap & Biomass Hub Jabalpur",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Adhartal Industrial Area",
      local_area: "Plot 42 Aggregation Depot",
      wallet_balance: 28400,
    },
    {
      id: "processor_1",
      phone: "9827011007",
      loginId: "recycler_plant",
      username: "recycler_plant",
      email: "ecocycle.plant@rupaykg.org",
      password: defaultHashedPassword,
      role: "processor",
      name: "EcoCycle Polymers & Pyrolysis Ltd",
      organization_name: "EcoCycle Registered Recycling Facility",
      district: "Indore",
      state: "Madhya Pradesh",
      subdistrict: "Sanwer Industrial Belt",
      local_area: "MRF & Pelletizing Plant",
      wallet_balance: 125000,
    },
    {
      id: "bulk_generator_1",
      phone: "9827011008",
      loginId: "bulk_generator",
      username: "bulk_generator",
      email: "hospital.jmc@rupaykg.org",
      password: defaultHashedPassword,
      role: "commercial_generator",
      name: "Metro Apex Healthcare & Commercial Complex",
      organization_name: "Apex Hospital & Commercial Towers (Rule 4(7) BWG)",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Civil Lines",
      local_area: "Civic Centre Hub",
      wallet_balance: 0,
    },
    {
      id: "carbon_dev_1",
      ...
      loginId: "carbon_dev",
      username: "carbon_dev",
      email: "carbon.project@rupaykg.org",
      password: defaultHashedPassword,
      role: "carbon_developer",
      name: "GreenSovereign CCTS Project Developers",
      organization_name: "GreenSovereign Climate Solutions (BEE Registered)",
      district: "Bhopal",
      state: "Madhya Pradesh",
      wallet_balance: 0,
    },
    {
      id: "acva_verifier_1",
      phone: "9827011010",
      loginId: "acva_verifier",
      username: "acva_verifier",
      email: "acva.auditor@rupaykg.org",
      password: defaultHashedPassword,
      role: "regulator",
      name: "National Energy & Carbon Verification Agency (ACVA)",
      organization_name: "Bureau of Energy Efficiency (BEE) Accredited ACVA",
      district: "Delhi",
      state: "Delhi",
      wallet_balance: 0,
    },
    {
      ...
      loginId: "epr_brand",
      username: "epr_brand",
      email: "cpcb.brand@rupaykg.org",
      password: defaultHashedPassword,
      role: "epr_partner",
      name: "Hindustan FMCG Packaging Alliance",
      organization_name: "CPCB EPR Obligated Brand Owner #CPCB-EPR-2024-889",
      district: "Mumbai",
      state: "Maharashtra",
    ...
    },
    {
      id: "citizen_user_1",
      phone: "9827011012",
      loginId: "citizen_user",
      username: "citizen_user",
      email: "ananya.sharma@rupaykg.org",
      password: defaultHashedPassword,
      role: "citizen",
      name: "Ananya Sharma (Resident Citizen)",
      organization_name: "Green Civic Resident Association",
      district: "Jabalpur",
      state: "Madhya Pradesh",
      subdistrict: "Jabalpur Urban",
      local_area: "Wright Town Ward 14",
      wallet_balance: 120,
    },
  ];
  const records: any[] = [];
